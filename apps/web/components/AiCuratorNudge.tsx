...
export default function AiCuratorNudge({ variant, query }: AiCuratorNudgeProps) {
  ...
  if (variant === "footer") {
    return (
      <div className="mt-section flex flex-col md:flex-row items-center justify-between py-md px-xl rounded-xl bg-ai-promo-bg border border-outline-variant shadow-sm gap-lg text-left animate-fade-in">
